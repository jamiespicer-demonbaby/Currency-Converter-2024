...
class CurrencyConverter:
    def __init__(self, master):
        ...
        style.configure('TButton', background='#4CAF50', font=('Trajan Pro', 15, "bold"))  # Green background
        ...
        ttk.Button(frame, text="Convert", command=self.convert).grid(row=4, column=0, columnspan=2, pady=10)
