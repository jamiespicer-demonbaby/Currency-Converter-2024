...
class CurrencyConverter:
    ...
    def create_history_tab(self):
        ...
        history_window.configure(bg='#D1E2D2')  # Light green background

        history_frame = ttk.Frame(history_window, padding=(20, 10), style='TFrame')
        history_frame.pack()

        history_label = ttk.Label(history_frame, text="Conversion History", font=('Trajan Pro', 16, 'bold'), style='TLabel')
        history_label.grid(row=0, column=0, columnspan=2, pady=10)

        history_listbox = tk.Listbox(history_frame, width=50, font=('Trajan Pro', 12), bg='#D1E2D2')
